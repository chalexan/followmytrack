...
async function getGeoJson() {
  const response = await fetch(
    `https://api.openrouteservice.org/v2/directions/foot-hiking?api_key=5b3ce3597851110001cf62484a7a6137e035499bb536ba601a7aea06&start=${startPos}&end=${endPos}`
  );
  const hopper = await fetch(
    `https://graphhopper.com/api/1/route?point=${startPosH}&point=${endPosH}&vehicle=hike&debug=true&key=9830c729-2019-4bab-8bbc-eb120d3867c4&type=json`
  );
  ...
  L.marker([
    geo.features[0].geometry.coordinates[0][1],
      ...
      const ftch = await fetch(
        "https://api.openrouteservice.org/v2/directions/foot-hiking/gpx",
        {
          ...
          headers: {
            ...
            Authorization:
              "5b3ce3597851110001cf62484a7a6137e035499bb536ba601a7aea06",
          },
          body: JSON.stringify({
            coordinates: [
              [sLon, sLat],
